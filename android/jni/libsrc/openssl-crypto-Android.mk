...
arm_cflags := -DOPENSSL_BN_ASM_MONT -DAES_ASM -DSHA1_ASM -DSHA256_ASM \
	-DSHA512_ASM -DOPENSSL_BN_ASM_GF2m -DKECCAK1600_ASM -DBSAES_ASM \
...
arm_src_files := \
	...
	bn/armv4-gf2m.S \
	bn/armv4-mont.S \
	chacha/chacha-armv4.S \
	ec/ecp_nistz256-armv4.S \
	modes/ghash-armv4.S \
	modes/ghashv8-armx.S \
	poly1305/poly1305-armv4.S \
	sha/keccak1600-armv4.S \
	sha/sha1-armv4-large.S \
	sha/sha256-armv4.S \
	sha/sha512-armv4.S \
	armv4cpuid.S
arm64_cflags := -DECP_NISTZ256_ASM
arm64_src_files := aes/aes_core.c \
	aes/aesv8-armx-64.S \
	chacha/chacha_enc.c \
	ec/asm/ecp_nistz256-armv8.S \
	modes/ghashv8-armx-64.S \
	sha/keccak1600.c \
	arm64cpuid.S
...
local_c_includes := \
	...
	$(NDK_PROJECT_PATH)/jni/openssl/crypto/ec/curve448 \
	$(NDK_PROJECT_PATH)/jni/openssl/crypto/ec/curve448/arch_32 \
	$(NDK_PROJECT_PATH)/jni/openssl/crypto/modes \
